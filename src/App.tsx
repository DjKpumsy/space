      ...
      <div className="w-full z-10 min-h-screen flex flex-col items-center text-white">
        ...
        <div className="fixed top-0 left-0 w-full px-4 pt-8 z-10 flex flex-col items-center text-white">
          ...
          <div className="text-base mt-2 flex items-center">
            <img src="https://img.icons8.com/arcade/100/time.png" width={30} height={30} alt="trophy" />
            <span className="ml-1">{new Date(timeLeft * 1000).toISOString().substr(11, 8)} </span>
          </div>
          )}
        </div>
        ...
        <div className="fixed bottom-0 left-0 w-full px-4 pb-8 z-10">
          ...
          <Button variant="filled" className="flex items-center " onClick={startFarming} disabled={isFarming}>
          {isFarming ? `Farming in progress... ${farmingPoints.toFixed(1)}` : 'Start Farming'}
